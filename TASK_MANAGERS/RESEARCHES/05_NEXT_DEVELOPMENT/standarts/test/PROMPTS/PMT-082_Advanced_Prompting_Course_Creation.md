...
subcategory: root
type: prompt
source_id: PMT-082_Advanced_Prompting_Course_Creation
title: PMT-082 Advanced Prompting Course Creation
date: 2025-11-21
status: draft
owner: unknown
related: []
...
1. **Replace `[AI name]`** with the target AI platform (e.g., "Claude", "ChatGPT", "Midjourney", "Gemini")
...
### Example 3: ChatGPT Lesson
**Input**: "Advanced Prompting in ChatGPT"  
**Output**: Lesson covering ChatGPT's capabilities, function calling, custom instructions, and workflow automation.
...
- ❌ Avoid generic "how AI works" content
- ❌ Don't include lengthy theoretical explanations
