...
```json
{
  ...
  "tool_name": "ToolName",
  "vendor": "VendorName",
  "category": "AI_Tools | Development | Design | AI | Automation | Infrastructure | Database",
...
- **Tool Categories:** AI_Tools, Development, Design, AI, Automation, Infrastructure, Database
...
- Actions: `Entities/LIBRARIES/Responsibilities/Actions/Actions_Master.json`
- Objects: `Entities/LIBRARIES/Responsibilities/Objects/objects.json`
