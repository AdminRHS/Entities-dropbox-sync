...
## Purpose
Reorganize the `Entities\LIBRARIES\Prompts` folder structure to align with Remote Helpers ecosystem standards, ensuring consistency, discoverability, and proper entity-based organization.
...
- Create `Archive/Session_Logs/`
- Move `SESSION_LOG_*.md` → `Archive/Session_Logs/`
- Create `Archive/Integration_Plans/`
- Move `INTEGRATION_*.md` → `Archive/Integration_Plans/`
- Move `Phase_2_Complete_Summary_Report.md` → `Archive/Integration_Plans/`
- Move `Prompts to run/` → `Archive/Legacy/Prompts_to_run/` (if still needed)
...
- `Archive/README.md` - Document archived content
