...
7. `Dropbox/Nov25/Finance/Finance prompt log.md` (FNC)
...
- ✅ Department codes correct (AID, HRM, DEV, LGN, DGN, VID, SLS, SMM, FNC, CNT)
...
2. Read all department prompt logs (AID, HRM, DEV, DGN, VID, LGN, SLS, SMM, FNC, CNT)
