...
DPT-009,FIN,Finance,Finance & Accounting,rgb(144,238,144),Financial operations and accounting,true,LIBRARIES/DEPARTMENTS/departments.json
```
...
6. **Department codes**: Use updated 3-letter codes (AID, HRM, DVL, LDG, DGN, VDO, SLS, SMM, FIN)
...
| Finance | FIN | **FIN** | Finance & Accounting |
