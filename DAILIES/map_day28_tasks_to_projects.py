...
tasks_file = os.path.join(OUTPUT_DIR, 'Day28_Tasks.json')
...
output_file = os.path.join(OUTPUT_DIR, 'Day28_Project_Mapping.md')
...
print(f'  Created: Day28_Project_Mapping.md')
print()

# Save enhanced tasks with project mapping
enhanced_tasks_file = os.path.join(OUTPUT_DIR, 'Day28_Tasks_With_Projects.json')
with open(enhanced_tasks_file, 'w', encoding='utf-8') as f:
    json.dump(tasks, f, indent=2, ensure_ascii=False)

print(f'  Created: Day28_Tasks_With_Projects.json')
print()
...
for project_id in sorted(by_project.keys()):
    ...
    project_file = os.path.join(OUTPUT_DIR, f'{project_id}_Day28_Tasks.json')
    with open(project_file, 'w', encoding='utf-8') as f:
        json.dump(project_tasks, f, indent=2, ensure_ascii=False)

    print(f'  Created: {project_id}_Day28_Tasks.json ({len(project_tasks)} tasks)')
