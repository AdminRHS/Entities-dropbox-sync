...
| ID | Task | Entities | Department | Priority |
|----|------|----------|------------|----------|
| **TSK-349** | Review GPT usage and costs | OBJ-###, ACT-### | Management + FNC | MEDIUM |
...
| **TSK-380** | Create task template schema | TSK-###, ACT-### | AID | MEDIUM |
...
| **TSK-393** | Integrate checklist items into task system | TSK-###, ACT-### | AID | LOW |
