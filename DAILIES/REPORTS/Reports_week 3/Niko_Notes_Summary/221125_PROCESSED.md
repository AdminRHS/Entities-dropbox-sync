...
| **TSK-032** | HR Onboarding preparation | MLT-###, TSK-### | PMT-038, PMT-056 | HIGH | [Google Sheet](https://docs.google.com/spreadsheets/d/1yYUD9nfHXdRfBkKUIrq_0v0hyJbKO8WpsUBPxkCYsZA/edit?gid=0#gid=0) |
...
| **TSK-054** | Connect Task Managers to Libs | TSK-###, OBJ-### | PMT-061, PMT-062 | HIGH | Sync template variations |
...
| **TSK-072** | Tasks Templates Execution System | TSK-###, STP-### | PMT-061 | HIGH | Multiple tasks allowed |
...
- TSK-081: Update all existing TSK-### with relevant PMT-###
