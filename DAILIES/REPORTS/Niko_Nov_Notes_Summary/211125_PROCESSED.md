...
| **TST-125** | Build Job Sites entity structure | ACT-008, OBJ-### | Vilhelm + AI | HIGH |
...
| **TSK-147** | Vilhelm: Create "Deep Research" task | TST-###, ACT-### | Vilhelm | MEDIUM | Pending |
...
| **TSK-160** | Test with Deep Research task | TST-###, ACT-### | Vilhelm | MEDIUM |
...
| **TSK-192** | Define pricing per profession | PRF-###, ACT-### | FIN + HRM | LOW |
...
| ID | Task | Entities | Department | Priority |
|----|------|----------|------------|----------|
| **TSK-211** | Design financial framework structure | OBJ-###, ACT-### | FIN + AID | MEDIUM |
| **TSK-212** | Create data sets for financial wiki | OBJ-###, ACT-### | FIN | MEDIUM |
| **TSK-213** | Document calculation sources | ACT-023, OBJ-### | FIN | MEDIUM |
...
**Departments Involved:** ALL (LGN, DEV, HRM, DGN, VID, AID, SMM, SLS, FIN)
