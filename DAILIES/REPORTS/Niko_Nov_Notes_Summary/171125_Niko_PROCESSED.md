...
| ID | Task | Entities | Department | Priority |
|----|------|----------|------------|----------|
| **TSK-428** | Structure financial folder architecture | OBJ-###, ACT-### | FIN + AID | HIGH |
| **TSK-429** | Create research list for Finance 2025 | PMT-051, ACT-### | FIN + AID | HIGH |
...
| ID | Task | Entities | Department | Priority |
|----|------|----------|------------|----------|
| **TSK-432** | Create employee 1:1 session template | TST-###, ACT-### | HRM | HIGH |
...
| **TSK-465** | Create weekly AI tutorial research template | TST-###, ACT-### | AID | MEDIUM |
| **TSK-466** | Convert SMM research into Task Templates | TST-###, ACT-### | SMM + AID | MEDIUM |
