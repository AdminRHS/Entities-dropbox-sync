...
| ID | Task | Entities | Department | Priority |
|----|------|----------|------------|----------|
| **TSK-248** | Cross-reference Task Manager with Online Academy | TST-###, OBJ-### | AID | HIGH |
...
| **TSK-252** | Create detailed onboarding tasks with steps | TST-###, STP-### | HRM + AID | HIGH |
...
| **TSK-259** | Create TSM-001_Project_Template | TST-###, ACT-### | AID | HIGH |
...
| **TSK-290** | Put video transcriptions into people tasks | TST-###, ACT-### | AID | MEDIUM |
...
| **TSK-306** | Task: Search for videos (template) | TST-###, ACT-### | VID | ONGOING |
